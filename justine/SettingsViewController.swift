...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row < 3 {
            ...
            case 0:
                ...
                slider.addTarget(self, action: #selector(SettingsViewController.handleSliderValueChange(_:)), for: UIControlEvents.valueChanged)
    ...
    func handleSliderValueChange(_ sender: CustomSlider) {
